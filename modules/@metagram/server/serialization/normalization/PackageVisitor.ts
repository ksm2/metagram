...
import { ModelElement } from '@metagram/framework';
import { XMI } from '@metagram/framework';
import { Package } from '@metagram/framework';
import { Visitor } from './Visitor';
import { ResolvedXMINode } from '../encoding/ResolvedXMINode';
import { XMIDecoder } from '../encoding/XMIDecoder';
import { Diagram } from '@metagram/framework';
