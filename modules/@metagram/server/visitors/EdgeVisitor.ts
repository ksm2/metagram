...
import { Edge } from '@metagram/framework';
import { Shape } from '@metagram/framework';
import { PackageImportElement } from '@metagram/framework';
import { GeneralizationElement } from '@metagram/framework';
import { AssociationElement } from '@metagram/framework';
